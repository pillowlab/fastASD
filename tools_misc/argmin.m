function [xval,inds,yval] = argmin(yy,varargin)
% [xval,inds,yval] = argmin(yy,varargin)
%
...
%  
% OUTPUTS:
%  xval - vector of coordinates at which min is obtained
%  inds - indices at which xval is maximal
%  yval - value of function at min
...
[yval,inds] = min(yy(:)); % find maximum of yy
